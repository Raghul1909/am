  ...
  <?php 
    if (isset($_POST['register'])) 
    {
      ...
      $c="INSERT into std_entry values('','$id','$studentName','$dob','$gender','$email','$phone','$add','$session','$program','$semester')";
    ...
    <form action="#" method="post" role="form">
        ...
        <div class="container">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="id" placeholder="Register Number" name="id">
          </div>
          </div>
         </div>
        </div>  <!-- col-container-->
