...
?>
     ...
     <tbody>
          ...
          <?php    
            ...
            $veiw ="select student_name,dob,gender,email,phone,address,session,Program,Semester from std_entry where id='1'";
            $view=mysqli_query($conn,$veiw);
            $veiw=mysqli_fetch_assoc($view);
